...
\draw [->] (-2,24.8) -- node[midway,fill=white] {
...
\draw [->] (8,11.5) -- node[midway,fill=white] {$\gamma \in \F$} (4,11.5);
...
\draw [->] (-2,3.5) -- node[midway,fill=white] {
$v_{g_2}, v_{A_\denom}, v_{B_\denom}, v_{C_\denom}, v_{g_1}, v_{\zb}, v_{t}$
} (15,3.5);
